...
public class GraphWeighted {
 ...
 // Necessary call if we want to run the algorithm multiple times
    ...
    public void DijkstraShortestPath(NodeWeighted start, NodeWeighted end) {
        ...
        StringBuffer o = new StringBuffer ("The the shortest path from ");
        ...
        while (true) {
            ...
            System.out.print("currentNode: "+currentNode.getName()+"\n");
            ...
            if (currentNode == null) {
            	JOptionPane.showMessageDialog(null,"There is no path between " 
            			+ start.name + " and " + end.name ,"ERROR", JOptionPane.INFORMATION_MESSAGE);
                return;
            }

            // If the closest non-visited node is our destination, we want to print the path
            if (currentNode == end) {
                o.append(start.name + " to " + end.name + " is ");
                ...
                + shortestPathMap.get(end),"Solution", JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            currentNode.visit();
            ...
            for (EdgeWeighted edge : currentNode.edges) {
                ...
                if (shortestPathMap.get(currentNode)+ edge.weight
